...
//class for the Deep Underground portal block
public class DUPortal extends Block{
	...
	//this spawns a portal in the overworld or the Deep Underground
	...
	//send the player to the Deep Underground or overworld
	@Override
